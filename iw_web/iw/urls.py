...
urlpatterns = [
    ...
    url(r'^dump_training_nparray_data/data/(?P<max_record_size>[0-9]+)/', data_manager.dump_training_nparray_data, name="dump_training_nparray_data"),
    url(r'^dump_validate_nparray_data/data/(?P<max_record_size>[0-9]+)/', data_manager.dump_validate_nparray_data, name="dump_validate_nparray_data"),
